        ...
        <div class="box black span4" onTablet="span6" onDesktop="span4">
            ...
            <div class="box-content">
                <ul class="dashboard-list metro">
                    <li class="green">
                        <a href="#">
                            <img class="avatar" alt="Lucas" src="{{url('')}}/backend/img/avatar.jpg">
                        </a>
                    ...
                    <li class="yellow">
                        <a href="#">
                            <img class="avatar" alt="Bill" src="{{url('')}}/backend/img/avatar9.jpg">
                        </a>
                    ...
                    <li class="red">
                        <a href="#">
                            <img class="avatar" alt="Jane" src="{{url('')}}/backend/img/avatar5.jpg">
                        </a>
                    ...
                    <li class="blue">
                        <a href="#">
                            <img class="avatar" alt="Kate" src="{{url('')}}/backend/img/avatar6.jpg">
                        </a>
